...
app.use(cors({ origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:3000', 'https://neelakantam-travels.netlify.app/', 'https://neelakantam-travels.netlify.app/booking']}));
